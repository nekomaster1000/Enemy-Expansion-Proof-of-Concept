...
import net.mcreator.enemyexpproofofconcept.entity.renderer.SprinterzombieRenderer;
...
public class SprinterzombieEntity extends EnemyexpproofofconceptModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.3f)).build("sprinterzombie").setRegistryName("sprinterzombie");

	public SprinterzombieEntity(EnemyexpproofofconceptModElements instance) {
		super(instance, 1);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SprinterzombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sprinterzombie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new LeapAtTargetGoal(this, (float) 0.45));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			SprinterzombieEntityIsHurtProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
