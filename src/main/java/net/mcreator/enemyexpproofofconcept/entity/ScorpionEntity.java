...
import net.mcreator.enemyexpproofofconcept.entity.renderer.ScorpionRenderer;
...
public class ScorpionEntity extends EnemyexpproofofconceptModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.5f, 1.1f)).build("scorpion").setRegistryName("scorpion");

	public ScorpionEntity(EnemyexpproofofconceptModElements instance) {
		super(instance, 11);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("scorpion_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.parrot.imitate.spider"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			ScorpionEntityIsHurtProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
