...
import net.mcreator.enemyexpproofofconcept.procedures.MeatmanzombieEntityIsHurtProcedure;
import net.mcreator.enemyexpproofofconcept.procedures.MeatmanSpawnsMeatureProcedure;
import net.mcreator.enemyexpproofofconcept.entity.renderer.MeatmanzombieRenderer;
...
public class MeatmanzombieEntity extends EnemyexpproofofconceptModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("meatmanzombie").setRegistryName("meatmanzombie");

	public MeatmanzombieEntity(EnemyexpproofofconceptModElements instance) {
		super(instance, 16);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MeatmanzombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("meatmanzombie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			MeatmanzombieEntityIsHurtProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void onDeath(DamageSource source) {
			...
			MeatmanSpawnsMeatureProcedure.executeProcedure(Stream
