...
import net.mcreator.enemyexpproofofconcept.entity.renderer.MeatureRenderer;
...
public class MeatureEntity extends EnemyexpproofofconceptModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("meature").setRegistryName("meature");

	public MeatureEntity(EnemyexpproofofconceptModElements instance) {
		super(instance, 9);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MeatureRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("meature_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.fromItems(Items.ROTTEN_FLESH), false));
			...
			this.goalSelector.addGoal(10, new OwnerHurtTargetGoal(this));
