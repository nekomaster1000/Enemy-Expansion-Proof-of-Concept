...
@OnlyIn(Dist.CLIENT)
public class SeniorzombieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SeniorzombieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsenior_zombie(), 0.6f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("enemyexpproofofconcept:textures/entities/senior_zombie.png");
					}
				};
			});
		}
