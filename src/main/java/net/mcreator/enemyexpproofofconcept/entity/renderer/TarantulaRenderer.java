...
@OnlyIn(Dist.CLIENT)
public class TarantulaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TarantulaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltarantula(), 0.6f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("enemyexpproofofconcept:textures/entities/tarantula.png");
					}
				};
			});
		}
